...
.PHONY: check check-strict ensure-tools syntax lint fmt-check smoke idempotency sync-test backup-restore-test failure-paths security public-preflight docker-install-flow sync-env-edges template-render release-policy-docs restore-hardening env-image-normalization

check: syntax smoke idempotency sync-test backup-restore-test failure-paths security public-preflight docker-install-flow sync-env-edges template-render release-policy-docs restore-hardening env-image-normalization

check-strict: syntax lint fmt-check smoke idempotency sync-test backup-restore-test failure-paths security public-preflight docker-install-flow sync-env-edges template-render release-policy-docs restore-hardening env-image-normalization
